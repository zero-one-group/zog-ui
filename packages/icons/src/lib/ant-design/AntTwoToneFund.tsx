...
export const AntTwoToneFund = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#E6E6E6"
        d="M136 792h752V232H136v560zm56.4-130.5 214.9-215c3.1-3.1 8.2-3.1 11.3 0L533 561l254.5-254.6c3.1-3.1 8.2-3.1 11.3 0l36.8 36.8c3.1 3.1 3.1 8.2 0 11.3l-297 297.2a8.03 8.03 0 0 1-11.3 0L412.9 537.2 240.4 709.7a8.03 8.03 0 0 1-11.3 0l-36.7-36.9a8.03 8.03 0 0 1 0-11.3z"
      />
      <path
        fill="#333"
