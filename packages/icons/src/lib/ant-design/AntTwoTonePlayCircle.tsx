...
export const AntTwoTonePlayCircle = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#333"
        d="M676.1 505.3 457.7 346.5A8 8 0 0 0 445 353v317.6a8.02 8.02 0 0 0 12.7 6.5l218.4-158.9a7.9 7.9 0 0 0 0-12.9z"
      />
    </svg>
  );
};
export default AntTwoTonePlayCircle;
