...
export const AntTwoToneSecurityScan = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#333"
        d="m418.8 527.8-77.5 77.5a8.03 8.03 0 0 0 0 11.3l34 34c3.1 3.1 8.2 3.1 11.3 0l77.5-77.5c55.6 35.1 130.1 28.4 178.6-20.1 56.3-56.3 56.3-147.5 0-203.8-56.3-56.3-147.5-56.3-203.8 0-48.5 48.5-55.2 122.9-20.1 178.6zm65.4-133.3a80.1 80.1 0 0 1 113.3 0 80.1 80.1 0 0 1 0 113.3c-31.3 31.3-82 31.3-113.3 0s-31.3-82 0-113.3z"
      />
    </svg>
  );
};
export default AntTwoToneSecurityScan;
