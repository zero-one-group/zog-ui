...
export const AntTwoToneHighlight = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      <path
        fill="#D9D9D9"
        d="M229.6 796.3h160.2l54.3-54.1-80.1-78.9zm220.7-397.1 262.8 258.9 147.3-145-262.8-259zm-77.1 166.1 171.4 168.9 68.6-67.6-171.4-168.9z"
      />
...
export default AntTwoToneHighlight;
