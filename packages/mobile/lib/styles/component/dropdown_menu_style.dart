...
/// [ZeroThemeData.colorScheme] and [ZeroThemeData.textTheme].
///
/// All of the [ZeroMenuStyle] properties are null by default.
///
/// Many of the [ZeroMenuStyle] properties are [MaterialStateProperty] objects which
...
/// MaterialApp(
///   theme: ZeroThemeData(
///     menuTheme: const MenuZeroThemeData(
...
@immutable
class ZeroMenuStyle with Diagnosticable {
  /// Create a [ZeroMenuStyle].
  const ZeroMenuStyle({
  ...
  /// elevation. See [ZeroThemeData.applyElevationOverlayColor].
  ...
  ///
  /// {@macro flutter.material.ZeroThemeData.visualDensity}
  ///
  /// See also:
  ///
  ///  * [ZeroThemeData.visualDensity], which specifies the [visualDensity] for all
