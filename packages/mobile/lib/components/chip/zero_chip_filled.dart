...
class ZeroChipFilled extends StatelessWidget {
  const ZeroChipFilled({
    Key? key,
    this.avatar,
    required this.label,
    this.cancelIcon,
  ...
  /// and the style will override that of the global theme [ZeroTheme.chipFilledStyle]
  final ZeroChipFilledStyle? style;

  @override
  Widget build(BuildContext context) {
    final theme = context.theme;
    // merge style with global style
    final adaptiveStyle = theme.chipFilledStyle.merge(style);
