...
/// push [ZeroDatePickerDialog] when the button is tapped.
///
...
/// See also:
///
///  * [showZeroDateRangePicker], which shows a Material Design date range picker
      ...
      return Theme(
          data: Theme.of(context).copyWith(
              colorScheme: ColorScheme.fromSwatch()
                  .copyWith(onPrimary: ZeroColors.white)),
...
///
/// It is used internally by [showZeroDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showZeroDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showZeroDatePicker], which is a way to display the date picker.
class ZeroDatePickerDialog extends StatefulWidget {
  /// A Material-style date picker dialog.
  ZeroDatePickerDialog({
    super.key,
    required DateTime initialDate,
  ...
  /// Restoration ID to save and restore the state of the [ZeroDatePickerDialog].
  ///
...
class _ZeroDatePickerDialogState extends State<ZeroDatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dateStyle = orientation == Orientation.landscape
        ? textTheme.headlineSmall?.copyWith(color: ZeroColors.black)
        : textTheme.headlineMedium?.copyWith(color: ZeroColors.black);
    ...
    final Widget header = Theme(
      data: Theme.of(context).copyWith(
          colorScheme: const ColorScheme.light(
              onPrimary: ZeroColors.black,
              primary: ZeroColors.white,
              onSurface: ZeroColors.black)), // TODO: to style
...
/// See also:
///
///  * [showZeroDatePicker], which shows a Material Design date picker used to
///    select a single date.
///  * [DateTimeRange], which is used to describe a date range.
///  * [DisplayFeatureSubScreen], which documents the specifics of how
///    [DisplayFeature]s can split the screen into sub-screens.
Future<DateTimeRange?> showZeroDateRangePicker({
  required BuildContext context,
...
///
/// It is used internally by [showZeroDateRangePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showZeroDateRangePicker] for a state restoration app example.
///
/// See also:
///
