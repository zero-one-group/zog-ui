...
///
class ZeroDatePickerInput extends StatefulWidget {
...
class _ZeroDatePickerInputState extends State<ZeroDatePickerInput> {
  ...
  @override
  void didUpdateWidget(ZeroDatePickerInput oldWidget) {
