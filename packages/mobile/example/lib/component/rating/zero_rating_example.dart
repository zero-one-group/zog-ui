            ...
            children: [
              ...
              ZeroRating(
                ...
                ratingWidget: RatingWidget(
                  full: const Icon(Icons.star, color: ZeroColors.sunriseYellow),
                  half: const Icon(Icons.star_half,
                      color: ZeroColors.sunriseYellow),
                  empty: Icon(Icons.star_border, color: ZeroColors.neutral[5]),
                ),
              ),
              const SizedBox(height: 20),
              ZeroRating(
                ...
                ratingWidget: RatingWidget(
                  full: const Icon(Icons.volume_up,
                      color: ZeroColors.primary, size: 30),
                  half: Icon(Icons.volume_mute,
                      color: ZeroColors.primary[4], size: 30),
                  empty: Icon(Icons.volume_mute,
                      color: ZeroColors.neutral[5], size: 30),
                ),
              ),
              // const SizedBox(height: 20),
              // ZeroRatingCustom(
