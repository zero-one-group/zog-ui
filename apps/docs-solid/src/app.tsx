      ...
      <div class="container mx-auto px-4 py-16">
        ...
        <div class="mb-12 flex justify-center space-x-8">
          ...
          <a
            ...
            class="transition-opacity hover:opacity-80"
          >
            <img src="/solid.svg" class="h-16 w-16" alt="SolidJS logo" />
          </a>
        </div>
        ...
        <div class="text-center">
          ...
          <div class="mx-auto mb-8 max-w-lg rounded-xl bg-slate-800/50 p-8 shadow-lg">
            ...
            <p class="mt-6 text-slate-300">
              Edit{' '}
              <code class="rounded bg-slate-700 px-2 py-1 text-sm">
                apps/docs-solid/src/app.tsx
              </code>{' '}
          ...
          <div class="space-y-2 text-slate-400">
            <p>Click on the Vite and SolidJS logos to learn more</p>
          </div>
        </div>
      </div>
    </div>
